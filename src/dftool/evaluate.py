"""
DFTool - Correlation Evaluator
Replay alert logs and compare baseline correlation scoring against FACES-v1.

Usage examples:
    dftool-eval --alerts-file /var/log/dftool/alerts.log
    dftool-eval --alerts-file ./alerts.jsonl --window-sec 300 --top 10
"""
...
def print_summary(
    ...
    print("=== DFTool Correlation Evaluation ===")
