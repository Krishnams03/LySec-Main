"""
LySec - Evaluation Plotter
Generate paper-ready figures from `lysec-eval` outputs.

Usage examples:
    lysec-eval-plot --input-json /tmp/lysec_eval.json --output-dir /tmp/plots
    lysec-eval-plot --input-csv /tmp/lysec_eval_incidents.csv --output-dir /tmp/plots
"""
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate threshold sweep and score distribution plots from lysec-eval outputs"
    )
    parser.add_argument("--input-json", help="Path to lysec-eval JSON report")
    parser.add_argument("--input-csv", help="Path to lysec-eval CSV incidents report")
