...
DEFAULT_CONFIG = {
    ...
    "monitors": {
        ...
        "process": {
            ...
            "shell_child_names": ["sh", "bash", "zsh", "dash", "ksh"],
            "env_keys": [
                "LD_PRELOAD",
                "LD_LIBRARY_PATH",
                "PYTHONPATH",
